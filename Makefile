back: main_back.o game.o easytimer.o teclado_trucho.o
	gcc -Wall main_back.o game.o easytimer.o teclado_trucho.o -o back `pkg-config --libs allegro-5`


front: main_front.o
	gcc -Wall main_front.o -o front `pkg-config --libs allegro-5`


main_front.o: main_front.c
	gcc -c -Wall main_front.c `pkg-config --cflags allegro-5`
