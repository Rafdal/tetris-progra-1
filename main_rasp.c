...
Audio *game_audio = createAudio(GAME_AUDIO, SDL_MIX_MAXVOLUME);
Audio *lose_audio = createAudio(LOSE_AUDIO, SDL_MIX_MAXVOLUME);
Audio *pause_audio = createAudio(PAUSE_AUDIO, SDL_MIX_MAXVOLUME);
Audio *menu_audio = createAudio(MENU_AUDIO, SDL_MIX_MAXVOLUME);
